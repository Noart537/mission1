...
<br />8. Excessive mic spamming, especially of Side Global and Command channels, will not be tolerated.
<br />9. A server moderator or admins word is final.
...
<br />
<br />Full rules can be found here: www.ahoyworld.net/index/rules/
"
]];
