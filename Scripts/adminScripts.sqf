...
MMIASide = [
	...
	["End current side",				[3], "", -5, [["expression","sideMissionUp = false;  publicVariable 'sideMissionUp'; cutText['ENDING SIDE', 'PLAIN'];"]],"", ""],
