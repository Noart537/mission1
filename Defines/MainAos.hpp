...
class AOs{
	class AAC_Airfield {
		...
		vehicles[] =
		{
			{"B_Heli_Light_01_armed_F", "aac_heli1",300},
			{"B_Heli_Light_01_F", "aac_heli2",450},
			{"I_Heli_Transport_02_F", "aac_heli3",300},
			{"I_Heli_light_03_unarmed_F", "aac_heli4",300},
			{"B_APC_Tracked_01_AA_F", "aac_veh1",1800},
			{"B_APC_Wheeled_01_cannon_F", "aac_veh2",1800},
			{"B_MRAP_01_F", "aac_veh3",450},
			{"B_MRAP_01_hmg_F", "aac_veh4",900},
			{"B_LSV_01_armed_F", "aac_veh5",450},
			{"B_LSV_01_unarmed_F", "aac_veh6",150},
...
/*	class Aggelorchori_Factory {
	...
	class Stadium {
		...
		vehicles[] =
		{
			...
			{"O_Heli_Light_02_unarmed_F", "sdm_heli2",300},
			{"B_MRAP_01_hmg_F", "sdm_veh1",900},
			{"B_MRAP_01_F", "sdm_veh2",450},
			{"B_LSV_01_armed_F", "sdm_veh3",450},
			{"B_LSV_01_unarmed_F", "sdm_veh4",150},
			{"B_Truck_01_fuel_F", "sdm_veh5",300},
			{"B_MBT_01_TUSK_F", "sdm_veh6",2700}
		};
	};
	class Power_Plant {
		name =  "Power Plant";
	...
	class Molos_Airfield {
		...
		vehicles[] =
		{
			...
			{"B_Heli_Transport_03_unarmed_F", "mol_heli1",300},
			{"I_Heli_light_03_F", "mol_heli2",900},
			{"B_T_MBT_01_cannon_F", "mol_veh1",2700},
			{"B_MRAP_01_F", "mol_veh2",450},
			{"B_MRAP_01_hmg_F", "mol_veh3",900},
			{"B_LSV_01_armed_F", "mol_veh4",450},
			{"B_LSV_01_unarmed_F", "mol_veh5",150},
	...
	class Terminal {
		...
		vehicles[] =
		{	
			{"Random_AA_Jet", "term_jet1",2700},
			{"O_Heli_Light_02_F", "term_heli1",2700},
			{"B_Heli_Light_01_F", "term_heli2",300},
			{"O_Heli_Transport_04_covered_black_F", "term_heli3",300},
			{"I_APC_Wheeled_03_cannon_F", "term_veh1",1800},
			{"B_MRAP_01_hmg_F", "term_veh2",900},
			{"B_MRAP_01_hmg_F", "term_veh3",900},
			{"B_MRAP_01_F", "term_veh4",450},
			{"B_MRAP_01_F", "term_veh5",450},
			{"B_Truck_01_fuel_F", "term_veh6",300}
		};
	};
	/*class Telos {
		name =  "Telos";
