...
Author: 
 ...
 Last edited: 
	20/10/2017 by stanhope
 
 Edited:
	Names of respawn markers + teleporter

 */

private ["_base","_baseRespawnMarker","_respawnMarkerPos","_respawnMarker","_basevisMarker","_arsenal","_arsenalBox","_targetStartText","_baseVehicles","_text","_vehType"];
...
_respawnMarker = [west, _respawnMarkerPos, _basevisMarker] call BIS_fnc_addRespawnPosition;
...
//stuf to be set on every box:
	...
	[_arsenal, ["<t color='#127a00'>Teleport to USS freedom</t>",
			   ...
			   "",-100,false,false,"","typeOf player == 'B_Pilot_F'||typeOf player == 'B_Helipilot_F'||typeOf player == 'B_soldier_UAV_F' || (_this getVariable 'isZeus')"]] remoteExec ["addAction", -2, true];

    //view and save gear:
	[_arsenal, ["<t color='#0098ff'>View Distance Settings</t>", CHVD_fnc_openDialog, [], -51, false, true, "","",4]] remoteExec ["addAction", -2, true];
	[_arsenal, ["<t color='#0098ff'>Save gear</t>",{player setVariable ["derp_savedGear", (getUnitLoadout player)]; systemChat "gear saved";}, [], -50, false, true, "","", 4]] remoteExec ["addAction", -2, true];
	
// Notification ----------------------------------------

_targetStartText = format["<t align='center' size='2.2'>Base Taken</t><br/><t size='1.5' align='center' color='#FFCF11'>%1</t><br/>____________________<br/>Good Job. We have now setup a base at that location.<br/><br/>We have provided you with some vehicles at that the new FOB.", _basevisMarker];
...
switch (_base) do {
	case "Terminal":{
        ...
        //arsenal box actions
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Martian</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AAC_Airfield'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-85,false,true,"","('AAC_Airfield' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Marathon</t>","cutText ['','BLACK OUT'];sleep 2;[player,'Stadium'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-86,false,true,"","('Stadium' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Dirt Track</t>","cutText ['','BLACK OUT'];sleep 2;[player,'Selakano_Town'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-87,false,true,"","('Selakano_Town' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Last Stand</t>","cutText ['','BLACK OUT'];sleep 2;[player,'Molos_Airfield'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-88,false,true,"","('Molos_Airfield' in controlledZones)"]] remoteExec ["addAction", -2, true];
    };
	...
	case "AAC_Airfield":{
        ...
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Marathon</t>","cutText ['','BLACK OUT'];sleep 2;[player,'Stadium'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-85,false,true,"","('Stadium' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Dirt Track</t>","cutText ['','BLACK OUT'];sleep 2;[player,'Selakano_Town'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-86,false,true,"","('Selakano_Town' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Last Stand</t>","cutText ['','BLACK OUT'];sleep 2;[player,'Molos_Airfield'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-87,false,true,"","('Molos_Airfield' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Guardian</t>","cutText ['','BLACK OUT'];sleep 2;[player,'Terminal'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-88,false,true,"","('Terminal' in controlledZones)"]] remoteExec ["addAction", -2, true];
    };
	...
	default { 
	_text = format ["ERROR with fn_BaseManager.sqf, %1 was not recognized as an FOB", _base];
	diag_log _text;
	};
